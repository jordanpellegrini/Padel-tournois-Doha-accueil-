...
export default function HomePage() {
  ...
  return (
    <main className="container">
      ...
      <div style={{ background: 'var(--white)', borderRadius: 12, padding: '20px 24px', marginBottom: 32, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 24, boxShadow: '0 4px 30px rgba(0,0,0,0.2)' }}>
